    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="card-body">
            ...
            <div className="space-y-3">
              <p className="text-base-content/80">
                <span className="font-medium">ID:</span> {client.authStore.record?.id}
              </p>
              <p className="text-base-content/80">
                <span className="font-medium">Email:</span> {client.authStore.record?.email}
              </p>
              <div className="flex gap-2">
                <span className="badge badge-ghost">Server Side</span>
        ...
        <div className="card bg-base-100 shadow-md md:col-span-2">
          <div className="card-body">
            <h2 className="card-title text-base-content mb-4">Recent Activity</h2>
              ...
              <table className="table table-zebra">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>3 days ago</td>
                    <td><span className="badge badge-warning">Changed</span></td>
                  </tr>
                </tbody>
              </table>
            </div>
